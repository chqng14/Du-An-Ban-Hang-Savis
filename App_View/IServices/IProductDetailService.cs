...
namespace App_View.IServices
{
    public interface IProductDetailService
    {
        ...
        Task<IActionResult> CreatProductDetailAsync(ProductDetailDTO productDetailDTO);
        ...
        Task<IActionResult> GetProductDetailForUpdateOrAdd(ProductDetailDTO productDetailDTO);
    }
}
